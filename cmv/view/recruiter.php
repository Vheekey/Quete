...
<body>
     <div class="rec container-fluid">
         <nav class="navbar navbar-dark bg-primary" style="background-color:#F8F8F8;">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand text-primary" href="#">Quete.com</a>
                </div>
     ...
     <div class="container text-primary">
        <h3 style="font-weight:bold;">What you can do as a recruiter</h3>
        <ul>
           <li>Create Vacancies</li>
           <li>Schedule Interviews whenever you want</li>
           <li>Set Screening questions to select best candidates for the job</li>
           <li>Manage Vacancies</li>
        </ul>
